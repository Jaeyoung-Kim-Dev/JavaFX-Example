...
public class LayoutExample extends Application {
	...
	public VBox addVBox() {
		...
		Hyperlink options[] = new Hyperlink[] { new Hyperlink("Operations"), new Hyperlink("Customer Service"),
				new Hyperlink("Marketing"), new Hyperlink("Sales") };
	...
	public GridPane addGridPane() {
		...
		ImageView imageHouse = new ImageView(new Image(LayoutExample.class.getResourceAsStream("home.gif")));
